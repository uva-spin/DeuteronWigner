...
`/Users/dustin/work/DeuteronWigner`. The 2026-09-04 publication represents
source milestone `e86b6c3f` through the documented C411/M2 state-current
boundary and preserves the former public history through merge `e97e75f6`.
Routine derivations and exploratory calculations do not need to wait for
snapshot publication or manifest regeneration.
