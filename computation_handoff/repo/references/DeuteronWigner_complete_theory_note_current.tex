...
This revision began from the code baseline at local main commit \texttt{186cc816} and the preceding documentation/handoff baseline at \texttt{3cbfc0bc}; the current represented source milestone is \texttt{e86b6c3f}, which commits the reviewed C411/M2 continuation, integrated Q0--Q2 substrate, and fail-closed state/current boundary.  The 2026-09-04 computation-handoff publication follows the history-preserving remote merge at \texttt{e97e75f6}; the older public C410 marker \texttt{51d3919e} remains historical evidence rather than current status.  The complete identifiers are recorded in \cref{app:reproducibility}.  The note is based on the checked-out source, the public repository and computation handoff, the complete 2026-08-28 source archive, the formalism volumes, the source-level audit, the C398--C400 records, the accepted C400.S2/S2M/S2M2 diagnostic-integrity layer, the C401--C410 source-operator progression, C411, and the current project handoff \cite{DeuteronWignerRepo2026,DWGTMDTechnicalDraft2026,DWFormalVolumes2026,DWSourceAudit2026,DWC398Record2026,DWC399Record2026,DWC400ScienceLock2026,DWC400P1Record2026,DWC400S2Record2026,DWC401C410Record2026,DWC411Record2026,DWCurrentHandoff2026}.
...
passes 36 tests; its five-test state-to-current boundary extension, including
negative qg-contamination and defective-isometry cases, passes 41 focused
tests. The direct C47-plus-boundary run passes 199 tests, and the final
relevant C47/C128/C401/C411/M2 regression passes 264 tests. These numerical
checks validate the stated exploratory construction and its convention
ownership only.
