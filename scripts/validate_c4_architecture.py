...
def main():
    ...
    assert len(normative["sources"]) == 6
    ...
    assert normative["volume_v_interface_assessment"]["ready_for_qcd_matching_or_evolution"] is False
    assert len(normative["cross_volume_coverage"]) == 6
    print(json.dumps({
